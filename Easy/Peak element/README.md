<h2><a href="https://practice.geeksforgeeks.org/problems/peak-element/1?page=1&category[]=Algorithms&sortBy=submissions">Peak element</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">An element is called a peak element if its value&nbsp;is not smaller than the value of&nbsp;its adjacent elements(if they exists).<br>
